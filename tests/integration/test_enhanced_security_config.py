#!/usr/bin/env python3
"""Integration tests for enhanced security configuration management.
...
class TestSecureConfigManager:
    ...
    def test_configuration_with_different_classifications(self, config_manager):
        ...
        test_cases = [
            ...
            (ConfigDataClassification.CONFIDENTIAL, {"business_secret": "confidential"}),
    ...
    def test_audit_logging(self, config_manager):
        ...
        # Check event details
        encrypt_events = [e for e in audit_events if e.operation == ConfigOperationType.ENCRYPT]
        decrypt_events = [e for e in audit_events if e.operation == ConfigOperationType.DECRYPT]
    ...
    def test_audit_event_filtering(self, config_manager):
        ...
        # Test user filtering
        user1_events = config_manager.get_audit_events(
            limit=10,
            user_filter="user1"
        )
    ...
    def test_security_status_reporting(self, config_manager):
        ...
        config_manager.encrypt_configuration(
            "status_test", {"data": "value"}, ConfigDataClassification.INTERNAL, "status_user"
        )
    ...
    def test_failed_operations_logging(self, config_manager):
        ...
        decrypt_failures = [
            ...
            if e.operation == ConfigOperationType.DECRYPT and 
               e.config_path == "nonexistent_config"
        ]
...
class TestEnhancedSecurityConfigIntegration:
    ...
    def test_config_operation_type_enum(self):
        ...
        expected_operations = [
            ...
            "encrypt", "decrypt", "backup", "restore", "validate"
        ]
