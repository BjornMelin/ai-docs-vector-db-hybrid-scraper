...
def mock_dependencies():
    ...
    deps["qdrant_service"].search.hybrid_search.return_value = [
        {
            "id": "1",
            "payload": {"content": "Machine learning is a subset of AI", "title": "ML Basics"},
            "score": 0.95,
        },
        {
            "id": "2", 
            "payload": {"content": "Deep learning uses neural networks", "title": "Deep Learning"},
            "score": 0.87,
        }
    ]
...
class TestEnhancedOrchestratorIntegration:
    ...
    async def test_enhanced_stats_with_rag_metrics(self, orchestrator_with_portfolio_features):
