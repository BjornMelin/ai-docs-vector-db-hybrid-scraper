...
class TestObservabilityIntegration:
    ...
    def test_observability_service_initialization_flow(
        ...
        with patch.dict('os.environ', {'AI_DOCS_MONITORING__ENABLE_METRICS': 'true'}):
            ...
            # Setup mocks
            mock_is_enabled.side_effect = [False, True]  # First not initialized, then initialized
...
class TestFastAPIObservabilityIntegration:
    ...
    def test_middleware_integration_disabled(self):
        ...
        with patch.dict('sys.modules', {
            ...
            # Add middleware
            self.app.add_middleware(FastAPIObservabilityMiddleware, **{
    ...
    def test_middleware_integration_with_metrics(self):
        ...
        with patch.dict('sys.modules', {
            ...
            with patch("src.services.observability.tracking.get_tracer", return_value=mock_tracer), \
                 patch("src.services.observability.tracking.get_meter", return_value=mock_meter):
...
class TestEndToEndObservabilityFlow:
    ...
    def test_observability_graceful_degradation(self):
        ...
        from src.services.observability.tracking import get_tracer, get_meter
