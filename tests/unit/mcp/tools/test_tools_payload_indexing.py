...
class TestPayloadIndexingTools:
    """Test cases for payload indexing tools functionality."""
    ...
    @pytest.mark.asyncio
    async def test_create_payload_index_tool_basic_functionality(self):
    ...
    @pytest.mark.asyncio
    async def test_optimize_payload_indexes_tool_basic_functionality(self):
    ...
    @pytest.mark.asyncio
    async def test_payload_indexing_tool_with_mocked_dependencies(self):
        """Test payload indexing tools with mocked service dependencies."""
        mock_mcp = MagicMock()
        mock_client_manager = MagicMock()
