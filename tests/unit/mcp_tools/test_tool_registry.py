...
class TestRegisterAllTools:
    ...
    async def test_logs_registration_progress(
        ...
        assert any(
            "Successfully registered 12 tool modules" in msg for msg in log_messages
        )
...
class TestLoggingBehavior:
    ...
    async def test_registration_count_is_accurate(
        ...
        # Should report 12 modules (since register_all_tools always tries to register all modules)
        assert "Successfully registered 12 tool modules" in summary_logs[0]
