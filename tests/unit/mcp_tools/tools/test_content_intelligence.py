...
def mock_content_service():
    ...
    service.get_performance_metrics = MagicMock(
        return_value={
            "total_analyses": 10,
...
class TestContentIntelligenceMCPTools:
    ...
    async def test_analyze_content_intelligence_success(
        self, mock_mcp, mock_client_manager, mock_context, mock_content_service
    ):
    ...
    async def test_analyze_content_intelligence_service_unavailable(
    ...
    async def test_analyze_content_intelligence_exception(
        self, mock_mcp, mock_client_manager, mock_context, mock_content_service
    ):
    ...
    async def test_classify_content_type_success(
        self, mock_mcp, mock_client_manager, mock_context, mock_content_service
    ):
    ...
    async def test_classify_content_type_service_unavailable(
        self, mock_mcp, mock_client_manager, mock_context
    ):
    ...
    async def test_assess_content_quality_success(
        self, mock_mcp, mock_client_manager, mock_context, mock_content_service
    ):
    ...
    async def test_assess_content_quality_service_unavailable(
        self, mock_mcp, mock_client_manager, mock_context
    ):
    ...
    async def test_extract_content_metadata_success(
        self, mock_mcp, mock_client_manager, mock_context, mock_content_service
    ):
    ...
    async def test_extract_content_metadata_service_unavailable(
        self, mock_mcp, mock_client_manager, mock_context
    ):
    ...
    async def test_get_adaptation_recommendations_success(
        self, mock_mcp, mock_client_manager, mock_context, mock_content_service
    ):
    ...
    async def test_get_adaptation_recommendations_service_unavailable(
        self, mock_mcp, mock_client_manager, mock_context
    ):
    ...
    async def test_get_content_intelligence_metrics_success(
        self, mock_mcp, mock_client_manager, mock_context, mock_content_service
    ):
    ...
    async def test_get_content_intelligence_metrics_service_unavailable(
        self, mock_mcp, mock_client_manager, mock_context
    ):
    ...
    async def test_tool_error_handling(
        ...
        mock_content_service.classify_content_type.side_effect = Exception(
