...
class TestToolCompositionEngine:
    ...
    async def test_analyze_goal(self):
        ...
        assert analysis["performance_priority"] == "speed"  # Due to low latency requirement
    ...
    def test_get_tool_metadata(self):
        ...
        # Add a test tool
        from src.services.agents.tool_composition import ToolMetadata, ToolCategory, ToolPriority
    ...
    def test_list_tools_by_category(self):
        ...
        search_tool = ToolMetadata(
            ...
            input_schema={}, output_schema={}, performance_metrics={}, dependencies=[]
        )
