...
class TestObservabilityConfigIntegration:
    ...
    def test_config_integration(self):
        ...
        try:
            ...
            assert obs_config.service_name == "ai-documentation-vector-db"  # Converted from app name
    ...
    def test_environment_variable_override(self):
        ...
        with patch.dict('os.environ', {
            ...
            try:
                ...
                assert config.service_name == "test-service-from-env"  # Converted from app name
    ...
    def test_nested_configuration_access(self):
        ...
        try:
            ...
            obs_config = get_observability_config()
            assert obs_config.enabled is False  # Should match monitoring.enable_metrics (false by default)
