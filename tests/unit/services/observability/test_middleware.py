...
class TestFastAPIObservabilityMiddleware:
    ...
    async def test_dispatch_with_correlation_id(self, mock_get_tracer):
        ...
        mock_span.set_attribute.assert_any_call("correlation.id", "test-correlation-123")
    ...
    async def test_dispatch_with_ai_context(self, mock_get_tracer):
        ...
        mock_span.set_attribute.assert_any_call("ai.operation.category", "vector_search")
    ...
    def test_add_ai_context_embedding_operation(self):
        ...
        span.set_attribute.assert_any_call("http.request.content_type", "application/json")
