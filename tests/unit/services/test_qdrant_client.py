...
class TestQdrantClientValidation:
    ...
    async def test_validate_connection_unauthorized(self, client):
        ...
        with patch("src.services.vector_db.client.AsyncQdrantClient") as mock_client_class:
            ...
            mock_client.get_collections.side_effect = ResponseHandlingException("Unauthorized")
    ...
    async def test_validate_connection_timeout(self, client):
        ...
        with patch("src.services.vector_db.client.AsyncQdrantClient") as mock_client_class:
            ...
            # Mock timeout error
            mock_client.get_collections.side_effect = ResponseHandlingException("Connection timeout")
