...
class TestMigrationFunctions:
    ...
    def test_compatibility_wrapper(self):
        ...
        expected_sections = ["qdrant", "openai", "firecrawl", "cache", "performance", "security", "chunking", "hyde", "reranking"]
...
class TestMigrationScenarios:
    ...
    def test_full_legacy_migration(self):
        ...
        assert modern_config.security.allowed_domains == ["example.com", "docs.example.com"]
