...
class TestValidateApiKeyCommon:
    ...
    def test_validate_api_key_common_non_ascii(self):
        ...
        with pytest.raises(ValueError, match="non-ASCII characters"):
            validate_api_key_common(
                "sk-ñoñoñoñoñoñoñoñoñoñoñoñoñoñoñoñoñoñoñoñoñoñoñoñoñoñoño",
                "sk-",
                "OpenAI",
            )
    ...
    def test_validate_api_key_common_test_key_too_short(self):
        ...
        with pytest.raises(
            ValueError, match="test API key contains invalid characters"
        ):
...
class TestValidateRateLimitConfig:
    ...
    def test_validate_rate_limit_config_zero_max_calls(self):
        ...
        config = {"openai": {"max_calls": 0, "time_window": 60}}
    ...
    def test_validate_rate_limit_config_negative_time_window(self):
        ...
        config = {"openai": {"max_calls": 100, "time_window": -60}}
...
class TestValidateModelBenchmarkConsistency:
    ...
    def test_validate_model_benchmark_consistency_mismatch(self):
        ...
        with pytest.raises(
            ValueError,
            match="Dictionary key .* does not match ModelBenchmark.model_name",
        ):
...
class TestConfigValidator:
    ...
    def test_validate_env_var_format_with_pattern(self):
        ...
        pattern = r"^AI_DOCS__.*"
        assert (
            ConfigValidator.validate_env_var_format("AI_DOCS__CONFIG", pattern) is True
        )
    ...
    def test_validate_api_key_firecrawl_valid(self):
        ...
        is_valid, error = ConfigValidator.validate_api_key(
            "fc-abcdef1234567890abcdef", "firecrawl"
        )
        assert is_valid is True
        assert error == ""
    ...
    def test_check_env_vars(self):
        ...
        assert (
            ...
            in results["AI_DOCS__WHITESPACE_VAR"]["issues"]
        )
        assert (
            "Value appears to be a placeholder"
            in results["AI_DOCS__PLACEHOLDER_VAR"]["issues"]
        )
    ...
    def test_generate_validation_report(self):
        ...
        with (
            patch.object(ConfigValidator, "check_env_vars", return_value={}),
            patch.object(
...
class TestValidatorIntegration:
    ...
    def test_comprehensive_validation_flow(self):
        ...
        assert (
            validate_api_key_common("sk-test123456789", "sk-", "OpenAI")
            == "sk-test123456789"
        )
    ...
    def test_config_validator_methods_consistency(self):
        ...
        # API key validation
        is_valid, _ = validator.validate_api_key(
            "sk-validkeyhere123456789012345678901234567890", "openai"
        )
        assert is_valid is True
    ...
    def test_env_var_value_conversion_edge_cases(self):
        ...
        for true_val in ["True", "TRUE", "tRuE", "1", "YES", "yes", "On", "ON"]:
            is_valid, converted, _ = validator.validate_env_var_value(
                "TEST", true_val, bool
            )
            assert is_valid is True
            assert converted is True
