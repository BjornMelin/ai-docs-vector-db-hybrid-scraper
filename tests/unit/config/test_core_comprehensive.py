...
class TestMainConfig:
    ...
    @patch.dict(
        os.environ, {"ENVIRONMENT": "production", "LOG_LEVEL": "ERROR", "DEBUG": "true"}
    )
    ...
    @patch.dict(
        os.environ,
        {"QDRANT__URL": "http://test.qdrant.com:6333", "OPENAI__API_KEY": "sk-test123"},
    )
...
class TestConfigSerialization:
    ...
    def test_config_from_dict(self):
        ...
        config_dict = {
            "environment": "testing",
            "log_level": "DEBUG",
            "cache": {"enable_caching": False, "local_max_size": 500},
        }
...
class TestSpecificConfigSections:
    ...
    def test_rate_limiting_config(self):
        ...
        config = Config(
            security__enable_rate_limiting=True, security__rate_limit_requests=500
        )
...
class TestEnvironmentSpecificConfigs:
    ...
    def test_development_config(self):
        ...
        config_dev = Config(
            environment=Environment.DEVELOPMENT, debug=True, log_level=LogLevel.DEBUG
        )
