...
class TestConfigBackupManagerAdditionalCoverage:
    ...
    def test_compress_backup_file(self):
        ...
        config_data = {"environment": "test", "data": "x" * 1000}  # Larger data for compression
    ...
    def test_detect_conflicts_database_url_changes(self):
        ...
        current_file = self.temp_dir / "current.json"
        current_data = {"database": {"database_url": "postgresql://localhost:5432/current"}}
        with open(current_file, 'w') as f:
            json.dump(current_data, f)
        
        backup_content = json.dumps({"database": {"database_url": "postgresql://remote:5432/backup"}})
