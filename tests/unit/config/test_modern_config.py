...
class TestApplicationModes:
    ...
    def test_enterprise_mode_features(self):
        ...
        config = Config(
            ...
            performance={"max_concurrent_crawls": 50}
        )
    ...
    def test_mode_specific_strategies(self):
        ...
        assert enterprise_config.get_effective_chunking_strategy() == ChunkingStrategy.ENHANCED
        assert enterprise_config.get_effective_search_strategy() == SearchStrategy.HYBRID
...
@pytest.mark.parametrize("mode,expected_crawls", [
...
@pytest.mark.parametrize("provider,api_key,should_pass", [
