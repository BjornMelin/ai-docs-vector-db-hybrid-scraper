...
class TestAllHealthChecks:
    ...
    def test_perform_all_health_checks_all_services(self):
        ...
        with patch.object(ServiceHealthChecker, 'check_qdrant_connection') as mock_qdrant, \
             patch.object(ServiceHealthChecker, 'check_dragonfly_connection') as mock_dragonfly, \
             patch.object(ServiceHealthChecker, 'check_openai_connection') as mock_openai, \
             patch.object(ServiceHealthChecker, 'check_firecrawl_connection') as mock_firecrawl:
    ...
    def test_get_connection_summary_all_healthy(self):
        ...
        with patch.object(ServiceHealthChecker, 'perform_all_health_checks') as mock_checks:
            ...
            assert set(summary["connected_services"]) == {"qdrant", "dragonfly", "openai"}
