...
from src.infrastructure.shared import ClientState, ClientHealth, CircuitBreaker
...
class TestCircuitBreaker:
    ...
    @pytest.mark.asyncio
    async def test_circuit_breaker_multiple_failures_opens_circuit(self, circuit_breaker):
    ...
    @pytest.mark.asyncio
    async def test_circuit_breaker_open_circuit_raises_immediately(self, circuit_breaker):
