...
class TestEnhancedSecurityConfig:
    """Test suite for EnhancedSecurityConfig model."""
    
    def test_enhanced_security_config_creation(self):
        """Test creation of EnhancedSecurityConfig with default values."""
    ...
    def test_enhanced_security_config_validation(self):
        """Test validation of EnhancedSecurityConfig fields."""
    ...
    def test_enhanced_security_config_inheritance(self):
        """Test that EnhancedSecurityConfig properly inherits from base SecurityConfig."""
        config = EnhancedSecurityConfig()
...
class TestSecureConfigManagerCore:
    ...
    def mock_security_validator(self):
        ...
        mock_validator.sanitize_filename.side_effect = lambda x: x.replace("/", "_").replace("\\", "_")
    ...
    def test_secure_config_manager_initialization(self, mock_validator_class, security_config, temp_config_dir):
    ...
    @patch('src.config.security.SecurityValidator')
    def test_checksum_calculation(self, mock_validator_class, security_config, temp_config_dir):
        ...
        different_checksum = config_manager._calculate_checksum(different_data, "sha256")
        assert checksum_sha256 != different_checksum
    
    @patch('src.config.security.SecurityValidator')
    def test_unsupported_hash_algorithm(self, mock_validator_class, security_config, temp_config_dir):
    ...
    def test_audit_logging_mechanism(self, mock_logger, mock_validator_class, security_config, temp_config_dir):
    ...
    @patch('src.config.security.SecurityValidator')
    def test_audit_logging_disabled(self, mock_validator_class, security_config, temp_config_dir):
    ...
    @patch('src.config.security.SecurityValidator')
    def test_security_status_reporting(self, mock_validator_class, security_config, temp_config_dir):
        ...
        assert status["integrity_checks_enabled"] == security_config.enable_config_integrity_checks
