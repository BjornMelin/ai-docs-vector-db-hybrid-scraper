...
@pytest.mark.asyncio
async def test_orchestrator_register_raises_with_partial_dependencies():
    """Agentic components without a client manager should trigger guard rails."""

    service = OrchestratorService()
    service.agentic_orchestrator = AsyncMock()
