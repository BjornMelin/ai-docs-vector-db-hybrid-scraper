...
def test_validate_configuration_requires_openai_key(build_unified_mcp_config):
...
def test_validate_configuration_requires_qdrant_url(build_unified_mcp_config):
...
def test_validate_configuration_warns_on_missing_firecrawl(
    build_unified_mcp_config, caplog
):
...
def test_validate_configuration_passes_for_valid_config(build_unified_mcp_config):
