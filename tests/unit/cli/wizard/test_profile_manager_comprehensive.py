...
class TestProfileManagerModern:
    ...
    def test_show_profiles_table_rich_output(self, rich_output_capturer):
        ...
        rich_output_capturer.assert_table_headers("Profile", "Template", "Use Case", "Key Features")
    ...
    def test_show_profile_setup_instructions_missing_template(self, rich_output_capturer):
    ...
    def test_create_profile_config_missing_template(self, tmp_path):
        ...
        # Mock template manager to return None
        manager.template_manager.create_config_from_template.side_effect = ValueError("Template not found")
