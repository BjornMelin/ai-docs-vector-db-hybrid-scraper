...
class TestConfigurationWizard:
    ...
    def test_welcome(self, rich_output_capturer):
        ...
        rich_output_capturer.assert_contains("Let's set up your AI Documentation Scraper!")
    ...
    def test_configure_database_local(self, mock_prompt, mock_confirm, rich_output_capturer):
    ...
    def test_configure_database_cloud(self, mock_prompt, mock_confirm):
        ...
        assert result == {
            "qdrant": {
                "url": "https://xyz.qdrant.tech:6333",
    ...
    @patch('rich.prompt.Confirm.ask')
    @patch('rich.prompt.Prompt.ask')
    def test_configure_performance_with_cache_and_queue(self, mock_prompt, mock_confirm, rich_output_capturer):
    ...
    @patch('rich.prompt.Prompt.ask')
    def test_save_configuration_json(self, mock_prompt, mock_file, rich_output_capturer):
    ...
    @patch('builtins.open', new_callable=mock_open)
    @patch('rich.prompt.Prompt.ask')
    def test_save_configuration_error_handling(self, mock_prompt, mock_file, rich_output_capturer):
    ...
    @patch('rich.prompt.Confirm.ask')
    def test_run_setup_complete_flow(self, mock_confirm, mock_welcome, mock_db, mock_embed,
                                   mock_browser, mock_perf, mock_save, rich_output_capturer):
        ...
        rich_output_capturer.assert_contains("Your AI Documentation Scraper is now configured")
...
class TestSetupCommand:
    ...
    def test_setup_command_basic(self, mock_config_loader, mock_wizard_class, cli_runner, mock_config):
    ...
    @patch('src.cli.commands.setup.ConfigurationWizard')
    @patch('src.cli.main.ConfigLoader')
    def test_setup_command_with_options(self, mock_config_loader, mock_wizard_class, cli_runner, mock_config):
    ...
    @patch('src.cli.main.ConfigLoader')
    @patch('rich.prompt.Confirm.ask')
    def test_setup_command_with_validation(self, mock_confirm, mock_config_loader, 
                                         mock_wizard_class, mock_validate, cli_runner, mock_config):
        ...
        # Mock user choosing to validate
        mock_confirm.return_value = True
    ...
    @patch('src.cli.main.ConfigLoader')
    @patch('rich.prompt.Confirm.ask')
    def test_setup_command_no_validation(self, mock_confirm, mock_config_loader, 
                                       mock_wizard_class, cli_runner, mock_config):
    ...
    @patch('src.cli.commands.setup.ConfigurationWizard')
    @patch('src.cli.main.ConfigLoader')
    def test_setup_command_keyboard_interrupt(self, mock_config_loader, mock_wizard_class, cli_runner, mock_config):
    ...
    @patch('src.cli.commands.setup.ConfigurationWizard')
    @patch('src.cli.main.ConfigLoader')
    def test_setup_command_general_exception(self, mock_config_loader, mock_wizard_class, cli_runner, mock_config):
