...
class TestInfrastructureIntegration:
    ...
    def test_utils_package_available(self):
        ...
        # Test imports work
        from tests.utils import assert_valid_response, TestDataGenerator, MockFactory
        from tests.utils import PerformanceTracker, ConfigManager
    ...
    def test_data_generation_integration(self):
        ...
        from tests.utils import generate_test_documents, generate_search_queries
    ...
    def test_mock_factories_integration(self):
        ...
        from tests.utils import create_mock_vector_db, create_mock_embedding_service
    ...
    def test_assertion_helpers_integration(self):
        ...
        from tests.utils import assert_valid_response, assert_error_response
    ...
    def test_pytest_markers_configured(self):
        ...
        expected_markers = [
            # Security markers
            "security", "vulnerability_scan", "penetration_test", "owasp", "input_validation",
            
            # Performance markers  
            "performance", "benchmark", "memory_test", "cpu_test", "throughput",
            
            # Accessibility markers
            "accessibility", "a11y", "wcag", "screen_reader", "keyboard_navigation", "color_contrast", "aria",
            
            # Contract markers
            "contract", "api_contract", "schema_validation", "pact", "openapi", "consumer_driven",
            
            # Chaos markers
            "chaos", "fault_injection", "resilience", "failure_scenarios", "network_chaos", 
