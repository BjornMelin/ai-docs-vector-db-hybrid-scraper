    ...
    class LoadTestRunner:
        ...
        async def _execute_load_test(
            ...
            **kwargs,
            ...
            metrics.throughput_rps = metrics.successful_requests / (
        ...
        async def _run_scalability_test(
            ...
            **kwargs,
            ...
            for step in range(1, steps + 1):
                ...
                metrics.peak_concurrent_users = max(
                    metrics.peak_concurrent_users, current_users
                )
        ...
        def _evaluate_success(self, result: LoadTestResult) -> bool:
            ...
            if metrics.response_times:
                ...
                p95_response_time_ms = (
                    self._percentile(metrics.response_times, 95) * 1000
                )
            else:
        ...
        def _identify_bottlenecks(self, result: LoadTestResult) -> list[str]:
            ...
            if avg_response_time_ms > 1000:
                bottlenecks.append(
                    f"High average response time: {avg_response_time_ms:.2f}ms"
                )
        ...
        def _generate_recommendations(self, result: LoadTestResult) -> list[str]:
            ...
            for bottleneck in bottlenecks:
                if "response time" in bottleneck.lower():
                    ...
                    recommendations.append(
                        "Review application logic for performance bottlenecks"
                    )
                ...
                if "throughput" in bottleneck.lower():
                    ...
                    recommendations.append(
                        "Optimize resource utilization and reduce blocking operations"
                    )
                ...
                if "variability" in bottleneck.lower():
                    ...
                    recommendations.append(
                        "Consider implementing circuit breakers and timeouts"
                    )
            ...
            return {
                ...
                "performance": {
                    ...
                    "avg_throughput_rps": round(
                        sum(r.metrics.throughput_rps for r in results) / len(results), 2
                    ),
                },
                "test_results": [
                    {
