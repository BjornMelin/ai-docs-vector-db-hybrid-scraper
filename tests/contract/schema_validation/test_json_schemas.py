...
class TestSchemaCompatibility:
    ...
    def test_schema_evolution(self, json_schema_validator):
        ...
        result_v2_extended = json_schema_validator.validate_against_schema(v2_data, v2_schema)
    ...
    def test_schema_breaking_changes(self, json_schema_validator):
        ...
        result_original = json_schema_validator.validate_against_schema(test_data, original_schema)
        assert result_original["valid"]
        
        # Should be invalid in breaking change
        result_breaking = json_schema_validator.validate_against_schema(test_data, breaking_schema)
