...
class ContractTestRunner:
    ...
    def generate_report(self) -> ContractTestReport:
        ...
        summary = {
            ...
            "contract_types": list(set(r.contract_type for r in self.results)),
            "avg_execution_time_ms": sum(r.execution_time_ms for r in self.results) / len(self.results) if self.results else 0,
...
class TestContractRunner:
    ...
    def test_contract_runner_with_multiple_contract_types(self):
        ...
        contract_types = ["api_contract", "json_schema", "openapi", "pact", "consumer_driven"]
        
        for i, contract_type in enumerate(contract_types):
            result = ContractValidationResult(
                test_name=f"test_{contract_type}_{i}",
                contract_type=contract_type,
                result=ContractTestResult.PASSED if i % 2 == 0 else ContractTestResult.FAILED,
                details={"test_id": i},
    ...
    def test_contract_runner_error_aggregation(self):
        ...
        test_cases = [
            ...
            {
                "errors": [],
                "warnings": ["Performance warning", "Style warning"]
            },
            {
        ...
        for i, case in enumerate(test_cases):
            result = ContractValidationResult(
                ...
                result=ContractTestResult.FAILED if case["errors"] else ContractTestResult.PASSED,
                details={},
                errors=case["errors"],
    ...
    @pytest.mark.contract
    def test_contract_runner_integration_with_fixtures(self,
        ...
        schema_validation = json_schema_validator.validate_data(valid_data, "search_result")
        ...
        schema_result = ContractValidationResult(
            ...
            contract_type="json_schema",
            result=ContractTestResult.PASSED if schema_validation["valid"] else ContractTestResult.FAILED,
        ...
        api_result = ContractValidationResult(
            ...
            contract_type="api_contract",
            result=ContractTestResult.PASSED if api_validation["valid"] else ContractTestResult.FAILED,
            details={"endpoint": "/api/search", "method": "GET"},
