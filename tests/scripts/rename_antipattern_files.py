...
FORBIDDEN_WORDS = ["enhanced", "modern", "advanced", "ultimate", "next_gen", "sophisticated"]
...
class FileRenamer:
    ...
    def rename_file(self, file_path: Path) -> bool:
        ...
        if new_path.exists() and new_path != file_path:
            ...
            counter = 1
            while True:
                numbered_path = new_path.parent / f"{new_path.stem}_{counter}{new_path.suffix}"
    ...
    def _update_imports(self, old_path: Path, new_path: Path):
        ...
        while project_root.parent.name != "repos" and project_root.parent != project_root:
...
def main():
    ...
    if args.pattern:
        ...
        FORBIDDEN_WORDS = [word for word in FORBIDDEN_WORDS if args.pattern.lower() in word.lower()]
