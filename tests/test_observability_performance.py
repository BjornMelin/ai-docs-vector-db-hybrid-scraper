...
class TestPerformanceMonitor:
    ...
    def test_monitor_async_operation(self):
        ...
        async def async_test():
            async with monitor.monitor_async_operation("async_test_operation") as performance_data:
...
class TestSpecializedMonitoring:
    ...
    def test_monitor_external_api_call(self):
        ...
        with monitor.monitor_external_api_call("github", "get_user") as performance_data:
            time.sleep(0.01)
...
class TestPerformanceEdgeCases:
    ...
    def test_statistics_with_empty_lists(self):
        ...
        metrics = PerformanceMetrics(
            operation_name="no_resource_operation",
            duration_ms=100.0,
            success=True
        )
        monitor._record_performance_metrics(metrics, "test")
