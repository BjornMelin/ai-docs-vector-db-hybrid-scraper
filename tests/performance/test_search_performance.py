...
class TestSearchPerformance:
    ...
    async def test_concurrent_search_throughput(
        ...
        assert max_throughput >= 20.0, f"Peak throughput {max_throughput:.1f} RPS insufficient"
    ...
    async def test_search_scalability_characteristics(
        ...
        for result in scalability_results:
            print(f"  Dataset {result['dataset_size']:4d}: "
    ...
    async def test_search_cache_performance_impact(
        ...
        expected_cache_hits = total_requests - len(test_queries)  # First occurrence of each query is a miss
