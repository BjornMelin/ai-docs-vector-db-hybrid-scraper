...
class FastConfig(BaseSettings, OptimizedConfigMixin):
    ...
    embedding: OptimizedEmbeddingConfig = Field(
        default_factory=OptimizedEmbeddingConfig
    )
    ...
    @classmethod
    @performance_timer
    def load_sync(cls, config_path: Path | None = None, **overrides) -> "FastConfig":
    ...
    async def load_async(
        cls, config_path: Path | None = None, **overrides
    ) -> "FastConfig":
...
class ConfigFactory:
    ...
    @classmethod
    def create_config(
        cls, config_type: str = "fast", use_cache: bool = True, **overrides
    ) -> FastConfig:
    ...
    async def create_config_async(
        cls, config_type: str = "fast", config_path: Path | None = None, **overrides
    ) -> FastConfig:
...
_dev_config: FastConfig | None = None
_prod_config: FastConfig | None = None
...
def get_config_for_environment(env: str | None = None) -> FastConfig:
...
async def load_config_async(
    config_path: Path | None = None, environment: str | None = None, **overrides
) -> FastConfig:
    ...
    return await ConfigFactory.create_config_async(
        config_type, config_path, **overrides
    )
