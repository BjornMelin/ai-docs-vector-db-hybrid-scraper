...
class MetricsCollector:
    ...
    async def stop_collection(self) -> Dict[str, Any]:
        ...
        logger.info(f"Stopped metrics collection. Duration: {collection_duration:.2f}s, Points: {len(self.metric_points)}")
    ...
    async def get_metric_summary(self, metric_name: str) -> Optional[MetricSummary]:
    ...
    async def generate_collection_summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "categorized_metrics": {
                ...
                "throughput": {k: v.model_dump() for k, v in throughput_metrics.items()},
    ...
    def export_prometheus_metrics(self) -> str:
        ...
        for metric_name, point in latest_metrics.items():
            ...
            # Add help text
            prometheus_lines.append(f"# HELP {prom_metric_name} {metric_name} from {point.source}")
    ...
    def _calculate_overall_statistics(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "most_frequent_metric": max(metric_counts.items(), key=lambda x: x[1])[0] if metric_counts else None
        }
    ...
    def get_collection_status(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "buffer_usage": {name: len(buffer) for name, buffer in self.metric_buffers.items()}
        }