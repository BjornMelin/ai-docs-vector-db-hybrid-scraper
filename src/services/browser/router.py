...
from src.services.browser.config import RouterSettings
...
class BrowserRouter:
    ...
    def __init__(
        ...
        *,
        ...
        self._unavailable: set[ProviderKind] = set()
    ...
    async def initialize(self) -> None:
        ...
        for provider in self._providers.values():
            try:
                ...
                self._unavailable.add(provider.kind)
    ...
    def _choose_order(self, request: ScrapeRequest) -> list[ProviderKind]:
        ...
        return [kind for kind in order if kind not in self._unavailable]
