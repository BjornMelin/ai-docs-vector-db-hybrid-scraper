...
class EnterpriseSearchService(BaseService):
    ...
    async def initialize(self) -> None:
        ...
        try:
            ...
            logger.error(f"Failed to initialize enterprise search service: {e}")
            raise
    ...
    async def search(self, request: SearchRequest) -> SearchResponse:
        ...
        try:
            ...
            response = SearchResponse(
                ...
                personalized=self.enable_personalization and request.user_id is not None,
            )
    ...
    async def _get_cached_result(self, key: str) -> Optional[SearchResponse]:
