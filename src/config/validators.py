...
class ConfigurationValidator:
    ...
    def validate_config_schema(self, config: Dict[str, Any], environment: str = "development") -> bool:
        """
    ...
    def _validate_environment_config(self, config: Dict[str, Any], environment: str) -> None:
        ...
        if debug is not None and not isinstance(debug, bool):
            self.errors.append(ValidationError(
                path="debug",
                message="Debug setting must be a boolean"
            ))
    ...
    def _validate_cache_config(self, cache_config: Dict[str, Any]) -> None:
        ...
        boolean_settings = ["enable_caching", "enable_local_cache", "enable_dragonfly_cache"]
    ...
    def _validate_qdrant_config(self, qdrant_config: Dict[str, Any]) -> None:
        ...
        if not qdrant_config:
            self.errors.append(ValidationError(
                path="qdrant",
                message="Qdrant configuration is required"
            ))
            return
    ...
    def _validate_security_config(self, security_config: Dict[str, Any], environment: str) -> None:
...
def validate_config_schema(config: Dict[str, Any], environment: str = "development") -> bool:
    """
...
def validate_deployment_readiness(config_dir: Union[str, Path], environment: str) -> Tuple[bool, Dict[str, Any]]:
    """
    ...
    if not config_file.exists():
        return False, {
            ...
            "error_count": 1,
            "warning_count": 0,
            "errors": [{"path": str(config_file), "message": "Configuration file not found"}],
            "warnings": []
        }
