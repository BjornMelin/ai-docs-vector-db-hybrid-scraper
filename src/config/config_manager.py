...
class ConfigFileWatcher(FileSystemEventHandler):
    ...
    def on_modified(self, event):
        ...
        if Path(event.src_path).resolve() == self.config_file.resolve():
            ...
            logger.info(
                f"Configuration file changed: {self.config_file}"
            )  # TODO: Convert f-string to logging format
...
class ConfigManager:
    ...
    def _start_file_watching(self) -> None:
        ...
        try:
            ...
            logger.info(
                f"Started watching configuration file: {self.config_file}"
            )  # TODO: Convert f-string to logging format
    ...
    def update_baseline(self) -> None:
        ...
        if self._config:
            ...
            logger.info(
                f"Updated configuration baseline (hash: {self._baseline_hash})"
            )  # TODO: Convert f-string to logging format
