...
class RichCLI:
    ...
    def show_welcome(self):
        ...
        welcome_text.append("\nHybrid AI documentation scraping system with vector database integration", style="")
...
@click.pass_context
def main(ctx: click.Context, config: Optional[Path], quiet: bool):
...
def completion(shell: str):
    ...
    comp = comp_cls(cli=main, ctx_args={}, prog_name=prog_name, complete_var=f"_{prog_name.upper().replace('-', '_')}_COMPLETE")
