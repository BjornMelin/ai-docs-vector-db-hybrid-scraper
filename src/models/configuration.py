"""Unified configuration models using Pydantic v2.

This module consolidates all configuration models across the application,
providing a single source of truth for all settings and configurations.
"""
...
# DocumentationSite model that was in the original file
