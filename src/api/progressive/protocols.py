...
class SearchProtocol(Protocol):
    ...
    @abstractmethod
    async def get_document(self, document_id: DocumentId) -> SearchResult | None:
...
class AdvancedSearchProvider(
    SearchProtocol, ComponentLifecycle, HealthCheckProtocol, Protocol
):
...
class ManagedEmbeddingProvider(
    EmbeddingProtocol, ComponentLifecycle, MonitoringProtocol, Protocol
):
