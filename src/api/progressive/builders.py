...
class EmbeddingConfigBuilder:
    ...
    def with_quality_tier(self, tier: Union[QualityTier, str]) -> "EmbeddingConfigBuilder":
    ...
    def with_custom_preprocessing(self, preprocessing: Dict[str, Any]) -> "EmbeddingConfigBuilder":
...
class SearchConfigBuilder:
    ...
    def with_strategy(self, strategy: Union[SearchStrategy, str]) -> "SearchConfigBuilder":
        """Set search strategy.
    ...
    def with_content_types(self, content_types: List[Union[ContentType, str]]) -> "SearchConfigBuilder":
...
class ProcessingConfigBuilder:
    ...
    def with_metadata_extraction(self, enabled: bool = True) -> "ProcessingConfigBuilder":
    ...
    def with_language_detection(self, enabled: bool = True) -> "ProcessingConfigBuilder":
    ...
    def with_content_classification(self, enabled: bool = True) -> "ProcessingConfigBuilder":
    ...
    def with_quality_assessment(self, enabled: bool = True) -> "ProcessingConfigBuilder":
...
class MonitoringConfigBuilder:
    ...
    def with_metrics_collection(self, enabled: bool = True) -> "MonitoringConfigBuilder":
...
class AdvancedConfigBuilder:
    ...
    def with_quality_tier(self, tier: Union[QualityTier, str]) -> "AdvancedConfigBuilder":
    ...
    def with_workspace(self, workspace_dir: Union[str, Path]) -> "AdvancedConfigBuilder":
    ...
    def with_custom_providers(self, providers: Dict[str, Any]) -> "AdvancedConfigBuilder":
    ...
    def with_experimental_features(self, features: Dict[str, bool]) -> "AdvancedConfigBuilder":
...
class AIDocSystemBuilder:
    ...
    Examples:
        ...
        Advanced:
            ...
            ...             lambda m: m.with_cost_tracking(enabled=True, budget_limit=100.0)
            ...         )
            ...     )
            ...     .build())
    """
