...
from .types import SearchOptions, ProgressiveResponse
...
class SimpleSearchResult:
    ...
    _analysis: Optional[Dict[str, Any]] = field(default=None, repr=False)
    _suggestions: Optional[List[str]] = field(default=None, repr=False)
    ...
    def _detect_content_type(self) -> str:
        ...
        if any(keyword in content_lower for keyword in ["def ", "class ", "import ", "function"]):
            return "code"
        elif any(keyword in content_lower for keyword in ["## ", "### ", "documentation"]):
...
class AIDocSystem:
    ...
    def __init__(
        ...
        *,
        ...
        self._search_service: Optional[VectorSearchService] = None
        self._crawling_manager: Optional[CrawlingManager] = None
        ...
        *,
        ...
        for result in raw_results:
            simple_result = SimpleSearchResult(
                ...
                _embedding=result.get("embedding") if options and options.include_embeddings else None,
            )
        ...
        *,
        ...
        for i in range(0, len(urls), batch_size):
            ...
            if progress_callback:
                ...
                progress_callback(progress, f"Processed {i + len(batch)}/{len(urls)} URLs")
