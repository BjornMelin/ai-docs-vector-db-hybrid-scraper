...
class PerformanceBenchmark:
    ...
    async def benchmark_playwright_integration(self, test_urls: List[str] = None) -> Dict[str, Any]:
        ...
        for profile in site_profiles:
            ...
            for url in test_urls:
                metrics = self.measure_memory_usage(
                    lambda: asyncio.run(anti_detection.apply_stealth_to_playwright_config(base_config, profile))
                )
