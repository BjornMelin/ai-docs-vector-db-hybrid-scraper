...
class LinkUpdater:
    ...
    def update_file_links(self, file_path: Path) -> int:
        ...
        try:
            ...
            if content != original_content:
                ...
                print(f"Updated {updates_made} links in {file_path.relative_to(self.docs_root)}")
    ...
    def update_all_links(self):
        ...
        print("-" * 60)
        print(f"Total updates: {total_updates} links in {len(self.updated_files)} files")
    ...
    def _save_update_log(self):
        ...
        log_data = {
            "updated_files": [str(f.relative_to(self.docs_root)) for f in self.updated_files],
