...
class StatusIndicatorAdder:
    ...
    def __init__(self, docs_dir: str = "docs"):
        ...
        self.directory_mappings = {
            "getting-started": ("Current", "New users and developers", "getting-started guide"),
            "tutorials": ("Current", "Users who learn by doing", "tutorial"),
            "how-to-guides": ("Current", "Developers with specific goals", "how-to guide"),
            "reference": ("Current", "Developers needing technical details", "reference documentation"),
            "concepts": ("Current", "Developers wanting to understand design", "concept explanation"),
            "operations": ("Current", "System administrators and DevOps teams", "operations guide"),
            "contributing": ("Current", "Contributors and team members", "contributing guide"),
            "archive": ("Deprecated", "Historical reference", "archived documentation"),
            "examples": ("Current", "Developers needing examples", "example documentation"),
            "features": ("Current", "Developers and product managers", "feature documentation")
        }
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Add status indicators to documentation files")
