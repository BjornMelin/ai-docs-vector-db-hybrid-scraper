...
def check_python_version() -> Tuple[bool, str]:
    ...
    if version >= (3, 13):
        ...
        return False, f"⚠️  Python {version.major}.{version.minor}.{version.micro} (3.13+ recommended)"
...
def print_summary(
    ...
    if func_percentage < 100:
        failed_func = [test for test, success in functionality_results.items() if not success]
...
def main():
    ...
    all_results = list(import_results.values()) + list(src_results.values()) + list(functionality_results.values())
