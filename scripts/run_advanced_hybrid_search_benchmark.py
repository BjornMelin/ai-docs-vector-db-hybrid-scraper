...
from benchmarks import AdvancedHybridSearchBenchmark, BenchmarkConfig, BenchmarkResults
...
def print_benchmark_summary(results: BenchmarkResults) -> None:
    ...
    """
    print("\n" + "="*80)
    print(f"🔍 ADVANCED HYBRID SEARCH BENCHMARK RESULTS")
    print("="*80)
...
async def main():
    ...
    try:
        ...
        results = await run_benchmark_suite(search_service, benchmark_config, output_dir)
